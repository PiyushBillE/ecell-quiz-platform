    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <p className="text-xl text-gray-500">Quiz not found or has no questions.</p>
          <button
  ...
  if (completed) {
    return (
      <div className="flex items-center justify-center min-h-screen px-4">
        <div className="max-w-2xl w-full text-center bg-white rounded-lg shadow-xl p-12">
          <div className="mb-6">
            <svg
          ...
          <p className="text-xl text-gray-600 mb-2">
            You have completed the <span className="font-semibold">{quiz.title}</span>
          </p>
